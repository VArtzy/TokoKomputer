...
if (isset($_POST["submit"])) {
    ...
    if (tambahTandaKeluarBarang($_POST, $username) > 0) {
        echo "
        <script>
        alert('Berhasil Menambah Tanda Keluar Barang Baru');
        document.location.href = 'tandaKeluarBarang.php';
        </script>
        ";
    } else {
...
if (isset($_POST["ubah"])) {
    ...
    // cek apakah daata berhasil diubah
    if (ubahTandaKeluarBarang($_POST, $username) > 0) {
        echo "
        <script>
        alert('Berhasil Memperbaiki Tanda Keluar Barang');
        document.location.href = 'tandaKeluarBarang.php';
        </script>
        ";
    } else {
...
if (isset($_POST["hapus"])) {
    ...
    // cek apakah daata berhasil diubah
    if (hapusTandaKeluarBarang($_POST, $username) > 0) {
        echo "
        <script>
        alert('Berhasil Menghapus Tanda Keluar Barang');
        document.location.href = 'tandaKeluarBarang.php';
        </script>
        ";
    } else {
...
$title = "Tanda Keluar Barang - $username";
...
<main id="main" class="hidden-print max-w-7xl mx-auto leading-relaxed tracking-wider px-8 py-8 md:mt-8">
    ...
    <?php if (isset($aksi[0]) && $aksi[0] === '1') : ?>
        <div class="tooltip tooltip-success tooltip-right" data-tip="ESC">
            <label for="my-modal-6" class="btn btn-success mb-4">Tambah Tanda Keluar Barang</label>
        </div>
    <?php endif; ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="tooltip tooltip-info tooltip-right" data-tip="Enter">
                                <a tabindex="1" href="tandaKeluarBarang.php?kode=<?= $i['NOTA']; ?>"><i class="fa-solid fa-pen-to-square text-sky-500 scale-150"></i></a>
                            </div>
                        </td>
                    </tr>
                <?php endforeach; ?>
            ...
            <form action="" method="POST">
                ...
                <div class="form-control">
                    ...
                    <label class="input-group">
                        <span>Nota:</span>
                        <input type="text" readonly name="NOTA" id="NOTA" value="<?= isIdExist('tanda_keluar_barang', 'NOTA', date('Ymd') . query("SELECT COUNT(*) + 1 as COUNT FROM tanda_keluar_barang WHERE TANGGAL = CURDATE()")[0]["COUNT"]) ?>" class="input">
                    </label>
                </div>
                <div class="form-control">
                    <label class="label">
                ...
                <div class="form-control">
                    ...
                    <label class="input-group">
                        <span>Solusi:</span>
                        <textarea name="SOLUSI" id="SOLUSI" class="textarea textarea-bordered w-full"></textarea>
                    </label>
                </div>
    ...
    <div class="hidden-print modal visible opacity-100 pointer-events-auto modal-bottom sm:modal-middle">
        <div class="modal-box">
            <form action="" method="POST">
                ...
                <h3 class="font-bold text-lg">Aksi Tanda Keluar Barang</h3>
                <div class="form-control">
                    <label class="label">
                        <label class="label-text" for="TANGGAL">Tanggal: </label>
                    </label>
