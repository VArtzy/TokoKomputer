    ...
    $(function() {
        $("#SUPPLIER_ID").autocomplete({
            ...
            select: function(event, ui) {
                $("#SUPPLIER_ID_AUTO").val(ui.item.id || ui.item.value)
            }
        });
            ...
            <form action="" method="POST">
                ...
                <div class="form-control">
                    ...
                    <label class="input-group">
                        ...
                        <input value="<?= date('Ymd') . query("SELECT COUNT(*) + 1 as COUNT FROM pelunasan_hutang WHERE TANGGAL = CURDATE()")[0]["COUNT"] ?>" required type="text" name="NO_PELUNASAN" id="KETERANGAN" class="input input-bordered">
                    </label>
                </div>
                <div class="form-control">
                    <label class="label">
                ...
                <input type="hidden" name="SUPPLIER_ID_AUTO" id="SUPPLIER_ID_AUTO">
                <div class="form-control">
                    <label class="label">
                ...
                <div class="overflow-x-auto w-full mt-8 mb-4">
                    <table class="table table-compact w-full">
                        ...
                        <tbody>
                            ...
                            <th>
                                <input class="input input-xs input-bordered max-w-[15ch]" type="text" id="NOTA_BELI" name="NOTA_BELI" />
                            </th>
                            <th>
...
<?php if (isset($_GET['nota'])) : ?>
    ...
    $NOTA_BELI = $itemp['NOTA_BELI'];
    $iteminfo = query("select (select SUM(jumlah*harga_beli) from item_beli where nota = '$NOTA_BELI') AS HUTANG, (select SUM(jumlah*harga_beli) from item_beli where nota = '$NOTA_BELI') - (select sum(nominal-diskon-retur-diskon_rp) from item_pelunasan_hutang where nota_beli = '$NOTA_BELI') AS SISA_HUTANG;")[0];
    ?>
                ...
                <div class="overflow-x-auto w-full mt-8 mb-4">
                    <table class="table table-compact w-full">
                        ...
                        <tbody>
                            ...
                            <th>
                                <input class="input input-xs input-bordered max-w-[15ch]" id="NOTA_BELI" type="text" value="<?= $itemp['NOTA_BELI']; ?>" name="NOTA_BELI" />
                            </th>
                            <th>
                                <input class="input input-xs input-bordered max-w-[15ch]" id="TOTAL" type="number" value="<?= round($iteminfo['HUTANG']); ?>" name="" />
                            </th>
                            <th>
                                <input class="input input-xs input-bordered max-w-[15ch]" id="KEKURANGAN" type="number" value="<?= round($iteminfo['SISA_HUTANG']); ?>" name="" />
                            </th>
                            <th>
                                <input class="input input-xs input-bordered max-w-[15ch]" type="number" value="<?= round($itemp['NOMINAL']); ?>" max="<?= $iteminfo['SISA_HUTANG']; ?>" name="TOTAL_PELUNASAN_NOTA" />
                            </th>
                            <th>
