            ...
            <form action="" method="POST">
                ...
                <div class="form-control">
                    ...
                    <label class="input-group">
                        ...
                        <input value="<?= date('Ymd') . query("SELECT COUNT(*) + 1 as COUNT FROM pelunasan_piutang WHERE TANGGAL = CURDATE()")[0]["COUNT"] ?>" required type="text" name="NO_PELUNASAN" id="KETERANGAN" class="input input-bordered">
                    </label>
                </div>
                <div class="form-control">
                    <label class="label">
