        ...
        <form action="" method="post">
                ...
                <div class="grid gap-4">
                    <div class="form-control">
                        <label class="input-group">
                            <span>Nota:</span>
                            <input tabindex="1" value="<?= date('Ymd') . query("SELECT COUNT(*) + 1 as COUNT FROM jual WHERE TANGGAL = CURDATE()")[0]["COUNT"]; ?>" required type="text" name="NOTA" id="NOTA" class="input input-bordered">
                        </label>
                    </div>
                    ...
                    <div class="flex flex-wrap gap-4">
                        ...
                        <div class="form-control">
                            ...
                            <label class="input-group">
                                ...
                                <input tabindex="1" type="text" name="KETERANGAN" id="KETERANGAN" maxlength="100" class="input input-bordered">
                            </label>
                        </div>
                    </div>
                </div>
                <div class="form-control" <label class="input-group">
            ...
            <div class="modal-action">
                ...
                <div class="tooltip tooltip-success" data-tip="CTRL + A">
                    <button tabindex="1" class="btn btn-success" onclick="return confirm('Apakah anda yakin ingin memesan?'); shoppingCart.clearCart()" type="submit" name="checkout">SIMPAN</button>
                </div>
            </div>
            </li>
        </form>
...
<div class="ticket">
    <p class="centered mb-4">PENJUALAN - joga-computer.com
    ...
    <table class="mb-4">
        ...
        <tbody>
            ...
            foreach ($data as $i => $d) : ?>
                <tr>
                    <td>
                        <?= query("SELECT NAMA FROM barang where KODE = '" . $d['id'] . "'")[0]['NAMA']; ?>
                    </td>
                    <td>
                        <?= $_POST['JUMLAH_BARANG'][$i] ?>x

                    </td>
                    <th>
                        <p><?= $_POST['HARGA_JUAL'][$i]; ?></p>
                        <p><?= $_POST['HARGA_JUAL'][$i] * $_POST['JUMLAH_BARANG'][$i]; ?></p>
                    </th>
                </tr>
            <?php endforeach; ?>
        </tbody>
