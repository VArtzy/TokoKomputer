    ...
    <form action="" method="POST">
        ...
        <ul class="flex flex-col gap-6 mb-4 justify-center">
            ...
            <li>
                ...
                <input placeholder="Kosongkan atau isi dengan benar untuk mengubah" value="" class="px-2 py-1 bg-slate-100 dark:bg-slate-700 dark:text-white rounded-sm" type="password" name="PASSWORD" id="PASSWORD">
            </li>
            <li>
                <label for="PASSWORD2">Password Baru: </label>
                <input placeholder="Kosongkan jika tidak ingin diubah" value="" class="px-2 py-1 bg-slate-100 dark:bg-slate-700 dark:text-white rounded-sm" type="password" name="PASSWORD2" id="PASSWORD2">
            </li>
            <li>
