...
if (isset($_POST["submit"])) {
    ...
    foreach ($_SESSION['tambah'] as $i => $t) {
        ...
        $KET1 = $_POST['T_KET1'][$i];
        $KET2 = $_POST['T_KET2'][$i];
        tambahItemNota($t['KODE_LAMA'], $_POST['T_BARANG_ID'][$i], $_POST['T_JUMLAH_BARANG'][$i], $_POST['T_HARGA_BELI'][$i], $_POST['T_HARGA_JUAL'][$i], $_POST['T_DISKON1'][$i], $_POST['T_DISKON2'][$i], $_POST['T_DISKON3'][$i], $_POST['T_DISKON4'][$i], $_POST['T_DISKON_RP'][$i], $_POST['T_SATUAN'][$i], $_POST['KETERANGAN'], $KET1, $KET2, $IMEI);
    }
    ...
    foreach ($_POST['BARANG_ID'] as $i => $d) {
        ...
        if (ubahJualItemNota($ID, $BARANG_ID, $JUMLAH_BARANG, $HARGA_BELI, $HARGA_JUAL, $DISKON1, $DISKON2, $DISKON3, $DISKON4, $DISKON_RP, $SATUAN, $_POST['KETERANGAN'], $KET1, $KET2, $IMEI) > 0) {
        } else {
...
<main id="main" class="max-w-7xl mx-auto leading-relaxed tracking-wider px-8 py-8 md:mt-8">
    ...
    <?php if (isset($_GET['open'])) : ?>
        ...
        <div class="modal rounded-none modal-bottom items-start modal-open">
                    ...
                    <div class="flex gap-4">
                        ...
                        <div class="form-control">
                            ...
                            <label class="input-group">
                                ...
                                <input type="text" name="KETERANGAN" value="<?= $notas['KETERANGAN']; ?>" id="KETERANGAN" maxlength="100" class="input input-bordered">
                            </label>
                        </div>
                    </div>
            ...
            <th>
                ...
                <?php if (!in_array($b['ID'], $_SESSION['hapus'])) : ?>
                    <a class="badge badge-error" type="submit" href="DetailInvoice.php?nota=<?= $nota; ?>&barang_id=<?= $b['ID']; ?>&open" name="hapus_item">Hapus</a>
                <?php endif; ?>
                <?php if (in_array($b['ID'], $_SESSION['hapus'])) : ?>
                    <a class="badge badge-error" type="submit" href="DetailInvoice.php?nota=<?= $nota; ?>&barang_id=<?= $b['ID']; ?>&batal&open" name="batal_hapus">Batal</a>
                <?php endif; ?>
            </th>
            </tr>
        <?php endforeach; ?>
        ...
        <th>
            ...
            <br>
            <input name="T_HARGA_JUAL[]" id="HARGA_JUAL[]" class="text-sm font-semibold opacity-70 harga-jual" value="<?= $t["TAMBAH_HARGA_JUAL"]; ?>"></input>
            <br>
            <br>
