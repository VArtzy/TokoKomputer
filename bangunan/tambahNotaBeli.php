...
if (isset($_POST["submit"])) {
    ...
    if (tambahBeli($nota, $username, $TOTAL, $_POST) > 0) {
        echo "<script>document.cookie = 'shoppingCartBeli' +'=; Path=/; Expires=Thu, 01 Jan 1970 00:00:01 GMT;';</script>";
        echo  "<script>
                ...
                <div class="grid gap-4">
                    <div class="form-control">
                        <label class="input-group">
                            <span>Nota:</span>
                            <input tabindex="1" value="<?= date('Ymd') . query("SELECT COUNT(*) + 1 as COUNT FROM beli WHERE TANGGAL = CURDATE()")[0]["COUNT"]; ?>" required type="text" name="NOTA" id="NOTA" class="input input-bordered">
                        </label>
                    </div>
