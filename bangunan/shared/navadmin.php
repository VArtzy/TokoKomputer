      ...
      <div class="dropdown">
        ...
        <ul tabindex="0" class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52 overflow-hidden">
          ...
          <ul id="myMenu" class="shadow-lg lg:hidden">
            ...
            <li><a href="jual.php">Laporan Jual</a></li>
            <li><a href="beli.php">Laporan Beli</a></li>
            <li><a href="barangTerbeli.php">Barang Terbeli</a></li>
            <li><a href="barangTerjual.php">Barang Terjual</a></li>
          </ul>
        </ul>
      </div>
    ...
    <div class="navbar-center hidden lg:flex">
      <ul class="menu menu-horizontal p-0 flex items-center">
        <div class="tooltip tooltip-bottom" data-tip="User & Admin Management">
          <li><a class="flex flex-col justify-between items-center px-2" href="userAndAdminManagement.php"><i class="fa-solid fa-user-gear"></i>
              <span class="text-xs">User & Admin</span>
            </a></li>
        </div>
        <li>
          <div class="dropdown dropdown-bottom dropdown-hover">
            <label tabindex="0" class="flex flex-col justify-between items-center gap-3"><i class="fa-solid fa-user-tie"></i>
        ...
        <li>
          <div class="dropdown dropdown-bottom dropdown-hover">
            <label tabindex="0" class="flex flex-col justify-between items-center gap-3"><i class="fa-solid fa-money-bills"></i>
        ...
        <li>
          <div class="dropdown dropdown-bottom dropdown-hover">
            <label tabindex="0" class="flex flex-col justify-between items-center gap-3"><i class="fa-solid fa-file-lines"></i>
        ...
        <div class="tooltip tooltip-bottom" data-tip="Launch Tokopedia">
          <li><a target="_blank" class="flex flex-col justify-between items-center gap-3" href="https://tokopedia.link/jogacomputer"><img class="h-6" src="../img/tokopedia.png" alt="Tokopedia">
              <span class="text-xs">Tokopedia</span></a>
          </li>
        </div>
        <div class="tooltip tooltip-bottom" data-tip="Launch Shopee">
          <li><a target="_blank" class="flex flex-col justify-between items-center gap-3" href="https://shopee.co.id/joga_computer"><img class="h-6" src="../img/shopee.png" alt="Shoope">
              <span class="text-xs">Shopee</span></a>
          </li>
        </div>
      </ul>
    </div>
