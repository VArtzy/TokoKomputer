...
if (!strpos($hakAkses, '4')) return header('Location: admin.php');

$item = query("SELECT * FROM Wilayah ORDER BY KETERANGAN ASC");
...
if (isset($_POST["submit"])) {
    ...
    if (tambahWilayah($_POST) > 0) {
        echo "
        <script>
        alert('Berhasil Menambah Wilayah Baru');
...
if (isset($_POST["ubah"])) {
    ...
    // cek apakah daata berhasil diubah
    if (ubahWilayah($_POST) > 0) {
        echo "
        <script>
        alert('Berhasil Memperbaiki Wilayah');
        document.location.href = 'Wilayah.php';
        </script>
        ";
    } else {
...
<main id="main" class="max-w-7xl mx-auto leading-relaxed tracking-wider px-8 py-8 md:mt-8">
    <h1 class="text-2xl font-semibold">Wilayah</h1>
    <h2 class="text-xl mb-4">Admin: <?= $username; ?></h2>

    <div class="tooltip tooltip-success tooltip-right" data-tip="ESC">
        <label for="my-modal-6" class="btn btn-success mb-4">Tambah Wilayah</label>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="tooltip tooltip-info tooltip-right" data-tip="Enter">
                                <a tabindex="1" href="Wilayah.php?kode=<?= $i['KODE']; ?>"><i class="fa-solid fa-pen-to-square text-sky-500 scale-150"></i></a>
                            </div>
                        </td>
                    </tr>
                <?php endforeach; ?>
    ...
    <div class="modal modal-bottom sm:modal-middle">
        <div class="modal-box">
            <form action="" method="POST">
                <h3 class="font-bold text-lg">Wilayah</h3>
...
<?php if (isset($_GET['kode'])) : ?>
    <?php
    $kode = $_GET['kode'];
    $item = query("SELECT * FROM Wilayah WHERE KODE = '$kode'")[0];
    ?>
    ...
    <div class="modal visible opacity-100 pointer-events-auto modal-bottom sm:modal-middle">
        <div class="modal-box">
            <form action="" method="POST">
                ...
                <h3 class="font-bold text-lg">Aksi Wilayah</h3>
                <div class="form-control">
                    <label class="label">
                        <label class="label-text" for="KODE">Kode: </label>
                    </label>
                ...
                <div class="modal-action">
                    ...
                    <div class="tooltip" data-tip="ESC (Tekan Lama)">
                        <a id="batal" href="Wilayah.php" for="my-modal-edit" class="btn">Batal</a>
                    </div>
                    <div class="tooltip tooltip-success" data-tip="CTRL + A">
