...
if (isset($_POST["submit"])) {
    ...
    if (ubahJenisAnggotaUser($_POST) > 0) {
        echo "
        <script>
        alert('Berhasil mengubah Jenis Anggota User');
        ...
        echo "        
        <script>
        alert('Gagal mengubah Jenis Anggota User');
        document.location.href = 'userAndAdminManagement.php';
        </script>";
    }
}

$title = "Edit Jenis Anggota";
include('shared/navadmin.php');
?>

<main id="main" class="md:grid place-items-center max-w-7xl mx-auto leading-relaxed tracking-wider px-8 py-8">
    <h1 class="md:mt-8 text-4xl mb-4 text-center text-amber-600 dark:text-amber-400">Edit Jenis Anggota</h1>
    <p class="max-w-[567px] mx-auto text-center text-slate-800 dark:text-amber-50 mb-8">Perbarui Jenis Anggota User.</a></p>
    ...
    <form action="" method="POST">
        ...
        <ul class="flex flex-col gap-6 mb-4 justify-center">
            ...
            <li>
                ...
                <input value="<?= $customer["JENIS_ANGGOTA"]; ?>" class="px-2 py-1 bg-slate-100 dark:bg-slate-700 dark:text-white rounded-sm" type="text" name="JENISANGOTA" id="JENISANGOTA">
            </li>
            <li>
